 ...
 * - Hr_staff（或 .env HR_STAFF_TABLE）：status NVARCHAR(20) 默认“在职”、leave_date DATETIME
 * - Sys_Users：is_active INT 默认 1
 *
 * 用法：在项目根目录执行
...
async function main() {
  ...
  console.log('目标账号表：dbo.[Sys_Users]；将补齐 is_active。')
