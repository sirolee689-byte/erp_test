...
export const OPERATION_AUDIT_ROUTE_RULES = [
  ...
  { method: 'GET', path: '/api/stock-stats/snapshots', action: '查询库存统计快照列表', targetTable: 'UB_ERP_Stock_stats_snapshot' },
  { method: 'GET', path: /^\/api\/stock-stats\/snapshots\/\d+\/lines$/, action: '查询库存统计快照明细', targetTable: 'UB_ERP_Stock_stats_snapshot_line' },
  { method: 'POST', path: '/api/stock-stats/generate', action: '生成库存统计报表', targetTable: 'UB_ERP_Stock_stats_snapshot' },
  { method: 'DELETE', path: /^\/api\/stock-stats\/snapshots\/\d+$/, action: '删除库存统计快照', targetTable: 'UB_ERP_Stock_stats_snapshot' },
