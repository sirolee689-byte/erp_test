...
export const OPERATION_AUDIT_ROUTE_RULES = [
  ...
  { method: 'GET', path: '/api/stock-stats/category-options', action: '查询库存统计类别候选', targetTable: 'UB_ERP_Stocks_material' },
  { method: 'GET', path: '/api/stock-stats/color-options', action: '查询库存统计颜色候选', targetTable: 'UB_ERP_Stocks_colorcode' },
  { method: 'GET', path: '/api/stock-stats/report', action: '查询库存统计报表', targetTable: 'UB_ERP_Stocks_Storage,UB_ERP_Stocks_out,UB_ERP_Stocks_material,UB_ERP_Stocks_colorcode' },
  ...
  { method: 'GET', path: '/api/stock-in-stats/category-options', action: '查询入库统计材料分类候选', targetTable: 'UB_ERP_Stocks_material' },
  ...
  { method: 'GET', path: '/api/stock-out-stats/category-options', action: '查询出库统计材料分类候选', targetTable: 'UB_ERP_Stocks_material' },
  ...
  { method: 'GET', path: '/api/stock-movement-stats/category-options', action: '查询出入库统计材料分类候选', targetTable: 'UB_ERP_Stocks_material' },
  ...
  { method: 'GET', path: '/api/stock-io-stats/category-options', action: '查询进销存统计材料分类候选', targetTable: 'UB_ERP_Stocks_material' },
  { method: 'GET', path: '/api/stock-io-stats/report', action: '查询进销存统计报表', targetTable: 'UB_ERP_Stocks_Storage,UB_ERP_Stocks_Storage_list,UB_ERP_Stocks_out,UB_ERP_Stocks_out_list,UB_ERP_Bom_000,UB_ERP_Stocks_material,UB_ERP_Stocks_colorcode' },
  ...
  { method: 'GET', path: '/api/material-flow-ledger/category-options', action: '查询材料流水账材料分类候选', targetTable: 'UB_ERP_Stocks_material' },
