 ...
 * @returns {Promise<Map<string, number>>} key = trimmed New_UB_ERP_Stocks_material.code
 */
 ...
 * @param {string} pq
 * @param {Map<string, number>} materialPxMap key = New_UB_ERP_Stocks_material.code
 */
