 ...
 * - uid → New_UB_ERP_User.UserID
 * - uname → New_UB_ERP_User.UserName（登录账号列 username/UserName，非 usercode、非 New_UB_ERP_User.uname）
 * - utruename → New_UB_ERP_User.truename
 */
...
/**
 * 按当前登录 usercode 查 New_UB_ERP_User，返回业务表审计三字段（优先于令牌缓存）。
