      ...
      <el-skeleton :loading="loading" animated :rows="6">
        <template #default>
          ...
          >
            ...
            <el-table-column prop="unit_name" label="使用单位" min-width="160" show-overflow-tooltip />
            <el-table-column prop="unit_name_tow" label="转换单位" min-width="160" show-overflow-tooltip />
            <el-table-column prop="change_bl" label="转换率" min-width="120" show-overflow-tooltip />
            <el-table-column label="换算率" min-width="280" show-overflow-tooltip>
